...
<html lang="fr">
	<head>
		<?php $meta = json_decode(file_get_contents("./constants/meta.json"), true)["conception-et-developpement-web-toulouse"]; ?>
						...
						<div class="slide-content row" data-mask-768="80">
							<div class="col-12 d-flex inner">
								<div class="left align-self-center text-center text-md-left">
									<h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">Créateur de site internet à Toulouse</h1>
            ...
            <div class="swiper-container no-slider animation slider-h-75">
				...
				<div class="content-box phoneOnly background-modale" style="width:60%;border-radius:6px;border:0px;">
					...
					<div class="container container1">
						<p class="p-modale">Nous sommes animés par la créativité. Nous créons des sites internet innovant pour vous aider à obtenir de meilleurs résultats et à vous consolider sur le marché.</p>
                    ...
                    <div class="col-12 col-md-6 pl-md-5 align-self-center text-center text-md-left">
                        <div class="row intro">
                            <div class="col-12 p-0">
                                <h2 class="appear h-phoneOnly super effect-static-text">Service de création de site internet à Toulouse.</h2>
                            ...
                            <div class="col-12 p-0">
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Conception de site internet innovant toulousain</h4>
                                ...
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        ...
                                        <p class="appear p-phoneOnly">Nous proposons une gamme complète de services interactifs, d'UI UX, de plateformes de <u class="bold-mot">gestion de contenu</u> intégrée et de solutions de conception réactive.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 p-0">
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        ...
                                        <p class="appear p-phoneOnly">Les <u class="bold-mot">sites web</u> et les solutions mobiles que nous concevons le sont de telle sorte à ce que ces dernières puissent être le plus attrayantes possibles et ainsi augmenter les taux de conversion et développer votre chiffre d'affaires.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                                <div class="row item">
                                    <div class="col-12 col-md-2 align-self-center">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        ...
                                        <p class="appear p-phoneOnly">Nous développons nos <u class="bold-mot">solutions web</u> en nous assurons qu’ils obtiennent la la meilleure expérience utilisateur quel que soit l’appareil utilisé pour gagner en uniformité et en fluidité.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row appear">
                    <div class="col-12 col-md-6 pl-md-5 align-self-center text-center text-md-left">
                        <div class="row intro">
                            <div class="col-12 p-0">
                                <h2 class="appear h-phoneOnly super effect-static-text">Création de site internet à Toulouse.</h2>
                            ...
                            <div class="col-12 p-0">
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        ...
                                        <p class="appear p-phoneOnly">Nous développons des <u class="bold-mot">sites web</u> flexibles pour vous permettre d’apporter les changements et modifications pour vos besoins d’évolutivité grâce à un panel d’outils hautement personnalisables.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                                <div class="row item">
                                    <div class="col-12 col-md-2 align-self-center">

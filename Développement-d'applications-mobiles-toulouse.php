            ...
            <div class="swiper-container no-slider animation slider-h-75">
				...
				<div class="content-box phoneOnly background-modale" style="width:60%;border-radius:6px;border:0px;">
					...
					<div class="container container1">
						<p class="p-modale">Nous sommes animés par la créativité. Nous créons des applications mobiles innovantes pour vous aider à obtenir de meilleurs résultats et à vous consolider sur le marché toulousain.</p>
                        ...
                        <div class="row items">
                            <div class="col-12 p-0">
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Conseils</h4>
                                        <p class="appear p-phoneOnly">Dark Moon se positionne comme un acteur clé dans le <u class="bold-mot">cycle de vie</u> de votre application mobile.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                                <div class="row item">
                                    <div class="col-12 col-md-2 align-self-center">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Prototypage</h4>
                                        <p class="appear p-phoneOnly">Nous réalisons ensemble des <u class="bold-mot">maquettes et des simulations</u> pour votre projet en toute confidentialité.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>

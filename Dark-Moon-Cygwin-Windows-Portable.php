                        ...
                        <div class="slide-content row" data-mask-768="80">
                            <div class="col-12 d-flex inner">
                                <div class="left align-self-center text-center text-md-left">
                                    ...
                                    <a href="https://www.microsoft.com/store/apps/9PJ369WKBV7F" class=" ml-auto mr-auto ml-md-0 mt-4 btn primary-button police-btn">TÉLÉCHARGER<i class="fab fa-windows" style="font-size:25px; margin-left: 10px; width: 0.5em;"></i></a>
							   </div>
                            </div>
                        </div>
                    </div>

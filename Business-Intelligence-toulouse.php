						...
						<div class="slide-content row" data-mask-768="80">
							<div class="col-12 d-flex inner">
								<div class="left align-self-center text-center text-md-left">
									<h1 data-aos="zoom-out-up" data-aos-delay="400" class="title effect-static-text">Business Intelligence à Toulouse</h1>
									<p data-aos="zoom-out-up" data-aos-delay="800" class="p-police-size description">Agence de Business Intelligence, Informatique décisionnelle à destination des dirigeants et managers à Toulouse.</p>
            ...
            <div class="container">
                <div class="row text-center intro">
                    <div class="col-12">
                        ...
                        <p class="text-max-800">Construisez le workflow de votre Outil de B & I avec les services suivants :</p>
                    </div>
                </div>
                <div class="row justify-content-center text-center items">
                    <div class="col-12 col-md-6 col-lg-4 margin-item">
                        <div class="card featured">
                            ...
                            <p>Les systèmes d’aide à la décisions sont employés dans les activités décisionnelles.<a style="color:#fff" href="contact.html"> En savoir plus</a></p>
						</div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card">
                            ...
                            <h4>Maintenance</h4>
                            <p>Nos logiciels d'aide à la décision sont multi-rôles, fiables et personnalisables. <a style="color:#fff" href="contact.html"> En savoir plus</a></p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card">
                            ...
                            <h4>objectifs</h4>
                            <p>Les données constituent la clé de voûte de votre entreprise lors de la prise de la décision.<a style="color:#fff" href="contact.html"> En savoir plus</a></p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card">
                            <i class="icon icon-layers"></i>
                            <h4>Outil sur mesure</h4>
                            <p>Nous déployons des logiciels d'informatiques décisionnelles sur mesure.<a style="color:#fff" href="contact.html"> En savoir plus</a></p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card">
                            ...
                            <p>Notre équipe est entièrement dévoués pour donner vie à votre projet.<a style="color:#fff" href="contact.html"> En savoir plus</a></p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 margin-item">
                        <div class="card featured">
                            ...
                            <p>Les sollutions de Business Intelligence sont méticuleusement testées.<a style="color:#fff" href="contact.html"> En savoir plus</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-container no-slider animation slider-h-75">
				...
				<div class="content-box phoneOnly background-modale" style="width:60%;border-radius:6px;border:0px;">
					...
					<div class="container container1">
						<p class="p-modale">Nous sommes animés par la créativité. Nous créons des outils de B & I innovants pour vous aider à obtenir de meilleurs résultats et à vous consolider sur le marché.</p>
                    ...
                    <div class="col-12 col-md-6 pl-md-5 align-self-center text-center text-md-left">
                        <div class="row intro">
                            <div class="col-12 p-0">
                                <h2 class="appear h-phoneOnly super effect-static-text">Business Intelligence à Toulouse.</h2>
                                <p class="appear p-phoneOnly">Qu'est-ce que la Business Intelligence ? À qui ça s'adresse ? Pour qui et Pourquoi ?</p>
                            </div>
                        </div>
                        <div class="row items">
                            <div class="col-12 p-0">
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Collecte de données</h4>
                                        <p class="appear p-phoneOnly">Ces <u class="bold-mot">données</u> sont d’une grande pertinence pour mettre en évidence les <u class="bold-mot">corrélations</u> entre différentes données.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                                <div class="row item">
                                    <div class="col-12 col-md-2 align-self-center">
            ...
            <div class="container">
                <div class="row appear ">
                    <div class="col-12 col-md-6 pl-md-5 align-self-center text-center text-md-left">
                        <div class="row intro">
                            <div class="col-12 p-0">
                                <h2 class="appear h-phoneOnly super effect-static-text">Processus B & I à Toulouse.</h2>
                                <p class="appear p-phoneOnly">Dark Moon spécialiste en déploiement d'outils de Business Intelligence à Toulouse.</p>
                            </div>
                        </div>
                        <div class="row items">
                            <div class="col-12 p-0">
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Outils de Business Intelligence</h4>
                                        <p class="appear p-phoneOnly">Les <u class="bold-mot">utilisateurs métier</u> peuvent facilement partitionner et sélectionner des ensembles de données complexes.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                                <div class="row item">
                                    <div class="col-12 col-md-2 align-self-center">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Automatisation</h4>
                                        <p class="appear p-phoneOnly">Permet d'obtenir des pistes et des prescriptions automatisées de façon pragmatique pour mettre en place le meilleur <u class="bold-mot">plan d'action</u> et générer des résultats optimaux.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row items">
                            <div class="col-12 p-0">
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Prise de décision</h4>
                                        <p class="appear p-phoneOnly">Les avantages autour des technologies de Business Intelligence s'articulent autour de <u class="bold-mot">l'accélération de la prise de décision</u> sur tous les plans.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                                <div class="row item">
                                    <div class="col-12 col-md-2 align-self-center">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Tendances du marché toulousain et national</h4>
                                        <p class="appear p-phoneOnly">La <u class="bold-mot">collecte intelligente de données</u> sur les clients, notamment sur leurs préférences et leurs <u class="bold-mot">comportements</u> permet d'augmenter le taux de fidélisation.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row appear ">
                    <div class="col-12 col-md-6 pl-md-5 align-self-center text-center text-md-left">
                        <div class="row intro">
                            <div class="col-12 p-0">
                                <h2 class="appear h-phoneOnly super effect-static-text">Logiciel B & I à Toulouse.</h2>
                                <p class="appear p-phoneOnly">Dark Moon pour vos besoins en collecte et analyse de données d'entreprise à Toulouse.</p>
                            </div>
                        </div>
                        <div class="row items">
                            <div class="col-12 p-0">
                                <div class="row item">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Gamme de logiciel B & I</h4>
                                        <p class="appear p-phoneOnly">Notre gamme complète de <u class="bold-mot">logiciel</u> de Business Intelligence comprend des <u class="bold-mot">services de conseils</u>, de modélisation et de conception de logiciels d'informatiques décisionnelles.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                                <div class="row item">
                                    <div class="col-12 col-md-2 align-self-center">
                                    ...
                                    <div class="col-12 col-md-9 align-self-center">
                                        <h4 class="appear h-phoneOnly">Logiciel d'analyse</h4>
                                        <p class="appear p-phoneOnly">Dark Moon propose des logiciels s'articulant autour de la visualisation des <u class="bold-mot">données</u> et reporting, de <u class="bold-mot">l'analyse</u> prédictive et prescriptive.<a class="ensavoirplus" href="contact.html"> En savoir plus</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center text-center items">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card no-hover">
                            <i class="icon icon-basket"></i>
                            <h4>Formation</h4>
                            <p>Nos équipes de formateurs vous cadrent pour l'exploitation de vos outil B & I.<a style="color:#fff" href="contact.html"> En savoir plus</a></p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card no-hover">
                            <i class="icon icon-screen-smartphone"></i>
                            <h4>Activités</h4>
                            <p>Nos services comprennent la stratégie, le déploiement et l'analyse.<a style="color:#fff" href="contact.html"> En savoir plus</a> </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="get" class="section-1 hero odd p-0">
            <div class="swiper-container no-slider animation slider-h-75">
				...
				<div class="content-box phoneOnly background-modale" style="width:60%;border-radius:6px;border:0px;">
					<header class="container pixel-border4k" style="border-radius: 4px;" >
						<a href="#" class="closebtn" style="font-size:2rem;color: #a1caff;"></a>
						<h2 class="titre-modale super effect-static-text" style="">B & I À TOULOUSE</h2>
					</header>
					<div class="container container1">
